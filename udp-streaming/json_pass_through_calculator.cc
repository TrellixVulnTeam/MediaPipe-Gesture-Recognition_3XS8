      ...
      if (!cc->Inputs().Get(id).IsEmpty()) {
        ...
        if (cc->Inputs().Get(id).Name() == "hand_rect"){
          ...
          std::string msg_buffer;
					...
					google::protobuf::util::MessageToJsonString(rect, &msg_buffer, options);
        ...
        std::string msg_buffer;
			  //google::protobuf::util::JsonPrintOptions options;
				//google::protobuf::util::MessageToJsonString(wrapper, &msg_buffer);
        wrapper->SerializeToString(&msg_buffer);
				
				//For testing
				std::cout << "Passing Wrapper: " << msg_buffer << std::endl;
